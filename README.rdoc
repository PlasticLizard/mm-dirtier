...
mm-dirtier was created to serve a single purpose: to enable persisting changes (instead of the full document) for MongoMapper documents by way of MongoDB's atomic operators.
