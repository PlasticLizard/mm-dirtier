...
Whether or not the deep dirty tracking mm-dirtier provides has any use beyond that, I have no idea. For that reason, I will only briefly discuss usage of the plugin. If anyone conceives of a use for this beyond document persistence and wants to know more, add an issue to the tracker stating as much and I'll expand the documentation.
